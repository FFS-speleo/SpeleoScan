  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-base-100 text-base-content">
      <div className="text-center space-y-6 p-8">
        ...
        {/* Message secondaire */}
        <p className="text-lg text-base-content/70 mb-8 max-w-md">Désolé, la ressource que vous recherchez n&apos;existe pas ou a été déplacée.</p>
        ...
        <div className="mt-8">
          <svg aria-hidden="true" className="w-32 h-32 mx-auto text-primary/30" fill="currentColor" viewBox="0 0 20 20">
            <path
              fillRule="evenodd"
